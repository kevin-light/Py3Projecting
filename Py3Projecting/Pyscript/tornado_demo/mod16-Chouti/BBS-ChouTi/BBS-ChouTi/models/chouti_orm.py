...
ENGINE = create_engine("mysql+pymysql://root:111111@127.0.0.1:3306/digchouti01?charset=utf8", max_overflow=5)
...
def add_new_type():
    ...
    ret.add_all([
        # NewsType(caption="11"),
        NewsType(caption="段子"),
        NewsType(caption="42区"),
        NewsType(caption="图片"),
        NewsType(caption="挨踢1024"),
        NewsType(caption="你问我答"),
    ])
    ret.commit()
# add_new_type()